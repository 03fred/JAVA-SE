...
public class CalendarioPadrao {
	...
	public static void main(String[] args) {
		...
		out.print("Data e horário:\t");
		out.print(calendario.get(Calendar.DAY_OF_WEEK));
		...
		out.print(":" + calendario.get(Calendar.SECOND) + " GMT ");
		...
		out.println("Mês alterado:\t" + df.format(calendario.getTime()));

		calendario.add(Calendar.DAY_OF_WEEK, 35);
		out.println("Dia alterado:\t" + df.format(calendario.getTime()));

		out.print("Dia da semana:\t"
				+ calendario.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG, Locale.getDefault()));
		
		out.print(" " + calendario.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG, Locale.ENGLISH));

		
		out.print(" " + calendario.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG, Locale.ITALIAN));
	}
